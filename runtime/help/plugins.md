...
* `micro`
    ...
    [BufPane](https://pkg.go.dev/github.com/schollz/aw/internal/action#BufPane)
    [InfoPane](https://pkg.go.dev/github.com/schollz/aw/internal/action#InfoPane)
    [Tab](https://pkg.go.dev/github.com/schollz/aw/internal/action#Tab)
    [TabList](https://pkg.go.dev/github.com/schollz/aw/internal/action#TabList)
...
* `micro/config`
    ...
    Relevant links:
    [Buffer](https://pkg.go.dev/github.com/schollz/aw/internal/buffer#Buffer)
    [buffer.Completer](https://pkg.go.dev/github.com/schollz/aw/internal/buffer#Completer)
...
* `micro/buffer`
    ...
    Relevant links:
    [Message](https://pkg.go.dev/github.com/schollz/aw/internal/buffer#Message)
    [Loc](https://pkg.go.dev/github.com/schollz/aw/internal/buffer#Loc)
    [display.SLoc](https://pkg.go.dev/github.com/schollz/aw/internal/display#SLoc)
    [Buffer](https://pkg.go.dev/github.com/schollz/aw/internal/buffer#Buffer)
    [Error](https://pkg.go.dev/builtin#error)
...
https://pkg.go.dev/github.com/schollz/aw/internal to see the full list
